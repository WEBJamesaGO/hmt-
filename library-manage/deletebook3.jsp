...
<!-- banner -->
	<div class="banner1">
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1><a href="index.html">工作室图书管理系统</a></h1>
				</div>
...
String sql=null,id=null;
int qty=0;
id=request.getParameter("id");
sql="delete from borrow where bookid='"+id+"'";  //先删除借阅记录
try{
...
sql="delete from book where bookid='"+id+"'";//删除书籍信息
try{
pstmt = sqlconnection.conn.prepareStatement(sql);
pstmt.executeUpdate();
%>
<center><h3>删除成功！</h3><br><br>
<a href="deletebook.html">返回</a></center>
<%
}catch (Exception e) {
	
%>
<center><h3>删除失败！</h3><br><br>
<a href="deletebook.html">返回</a></center>
<%
	}	
%>
