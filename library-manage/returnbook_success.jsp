...
String sql=null,cardid=null,bookid=null,bdate=null,sdate=null;
cardid=request.getParameter("cardid");
bookid=request.getParameter("bookid");
bdate=request.getParameter("bdate");
sql="select sdate from borrow where bookid='"+bookid+"' and cardid='"+cardid+"' and bdate='"+bdate+"'";
try{
